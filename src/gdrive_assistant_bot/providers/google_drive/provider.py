...
from .clients import get_thread_clients
...
class GoogleDriveProvider(StorageProvider):
    ...
    def list_files(
        ...
        try:
            drive, _, _ = get_thread_clients(settings.STORAGE_GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON)
        except Exception:
            log.exception(
    ...
    def build_extraction_context(
        ...
        drive, docs, sheets = get_thread_clients(settings.STORAGE_GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON)
    ...
    def _build_drive_query_terms(self, file_filter: FileTypeFilter) -> list[str]:
        ...
        for ext in sorted(file_filter.extensions):
